    ...
    <div className='container w-[480px] mx-auto flex justify-center bg-[#F8FAFE] min-h-screen'>
      <div className='w-full px-5 font-[T-Regular]'>
        ...
        <div className='flex justify-between justify-items-center pt-10'>
          ...
          <p className='select-none text-xl'>New</p>
          ...
          <form action='' className='flex flex-col gap-5'>
            ...
            <div className='flex justify-center items-center gap-4'>
              ...
              <div className='flex flex-col'>
                <button className='w-[48px] h-[30px] bg-white rounded-t-lg text-[#007FFF] focus:bg-[#007FFF] focus:text-white hover:bg-[#007FFF] hover:text-white'>
                  AM
                </button>
                <button className='w-[48px] h-[30px] bg-white rounded-b-lg text-[#007FFF] focus:bg-[#007FFF] focus:text-white hover:bg-[#007FFF] hover:text-white'>
                  PM
                </button>
              </div>
            </div>
